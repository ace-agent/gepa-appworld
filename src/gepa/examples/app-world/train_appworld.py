...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-name", type=str, default="sambanova/DeepSeek-V3.1")
...
### CHEATSHEET END"""
    ...
    model_path_name = "-".join(reflection_lm_name.split('/'))
    run_dir = f"gepa_app_world_{model_path_name}"
